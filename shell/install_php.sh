...
if [ -e /root/oniguruma-6.7.0-1.el7.x86_64.rpm  ] ;then
		...
		wget --no-check-certificate https://raw.githubusercontent.com/rookiecloud/lnmp/main/soft/oniguruma-6.7.0-1.el7.x86_64.rpm
		yum -y install oniguruma-6.7.0-1.el7.x86_64.rpm
fi
if [ -e /root/oniguruma-devel-6.7.0-1.el7.x86_64.rpm  ] ;then
		...
		wget --no-check-certificate https://raw.githubusercontent.com/rookiecloud/lnmp/main/soft/oniguruma-devel-6.7.0-1.el7.x86_64.rpm
		yum -y install oniguruma-devel-6.7.0-1.el7.x86_64.rpm
fi
if [ -e /root/php-7.4.33.tar.gz  ] ;then
		tar -zxf php-7.4.33.tar.gz 
	else
		wget --no-check-certificate https://raw.githubusercontent.com/rookiecloud/lnmp/main/soft/php-7.4.33.tar.gz 
        tar -zxf php-7.4.33.tar.gz 
fi
...
if [ -e /root/redis-6.0.2.tgz  ] ;then
		...
		wget --no-check-certificate https://raw.githubusercontent.com/rookiecloud/lnmp/main/soft/redis-6.0.2.tgz
        tar -zxf redis-6.0.2.tgz
fi
